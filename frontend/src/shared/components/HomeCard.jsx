...
export function HomeCard({
  ...
  return (
    ...
    >
      <div
        className={`flex flex-col ${config.padding} relative overflow-visible`}
      >
        <div className="flex items-center justify-between mb-3 gap-2">
          ...
          <span
            className={`${config.dateSize} text-gray-400 whitespace-nowrap flex-shrink-0`}
          >
            {date}
          </span>
        </div>
        ...
        <h3
          className={`${config.titleSize} text-gray-900 m-0 leading-normal flex-1 line-clamp-2 pr-8`}
        >
          {title}
        </h3>
