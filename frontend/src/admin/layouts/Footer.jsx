...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-white py-4 px-8 mt-auto transition-all duration-300 shadow-[0_-2px_4px_rgba(0,0,0,0.05)] max-md:py-3 max-md:px-4 max-sm:py-2 w-full">
