...
export function BriefcaseIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 20 20">
      <path
        fillRule="evenodd"
        d="M6 6V5a2 2 0 012-2h2a2 2 0 012 2v1h2a2 2 0 012 2v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a2 2 0 012-2h2zm2-1a1 1 0 011 1v1h2V5a1 1 0 011-1h2a1 1 0 011 1v1h2a1 1 0 011 1v3.57A22.952 22.952 0 0110 13a22.95 22.95 0 01-8-1.43V8a1 1 0 011-1h2z"
        clipRule="evenodd"
      />
...
// Alias for PaperclipIcon
export const PaperClipIcon = PaperclipIcon;
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 8h10a4 4 0 014 4v4a4 4 0 01-4 4H7a4 4 0 01-1.564-.317z"
      />
    </svg>
  );
}
